...
<!--        <div style="margin: 10px 0" class="masonry">-->
<!--            <el-row :gutter="10">-->
<!--                <el-col :span="6" v-for="item in files" :key="item.id" style="margin-bottom: 10px">-->
<!--                    <div style="border: 1px solid #ccc; padding-bottom: 10px" class="item">-->
<!--                        <img :src="item.url" alt="" style="width: 100%">-->
<!--                        <div style="color: #666; padding: 10px" class="title">{{ item.name }}</div>-->
...
<!--        </div>-->
        ...
        <div class="masonry" >
            <div class="item"  v-for="item in files" :key="item.id" >
                <img :src="item.url" alt="" style="width: 100%">
                <div class="title" style="color: #666; padding: 10px">{{ item.name }}</div>
                <div style="padding: 10px"><el-button type="primary">购买</el-button></div>
            </div>
        </div>
    </div>

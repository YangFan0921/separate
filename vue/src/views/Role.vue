...
<!--                <el-upload action="http://localhost:9090/role/import" style="display: inline-block" :show-file-list="false" accept="xlsx" :on-success="handleImportSuccess">-->
...
<!--                <el-button type="primary" @click="exportUser" class="ml-5">导出 <i class="el-icon-top"></i></el-button>-->
        ...
        <el-table :data="tableData" border stripe header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="flag" label="唯一标识" width="160">
            </el-table-column>
            <el-table-column prop="description" label="描述">
            </el-table-column>
            <el-table-column label="操作" width="280">
                <template slot-scope="scope">
                    <el-button type="primary" @click="selectMenu(scope.row)">分配菜单 <i class="el-icon-menu"></i></el-button>
...
<script>
    export default {
        ...
        methods:{
            ...
            del(id){
                this.request.get("/role/delete/"+id).then(res => {
                    if (res == 1){
